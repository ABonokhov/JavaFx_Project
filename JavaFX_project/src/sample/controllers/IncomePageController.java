...
public class IncomePageController {
    ...
    void initialize() throws IOException {
        ...
        SendIncomeButton.setOnAction(new EventHandler<ActionEvent>() {            //действие при нажатии на кнопку Войти
            @Override
            public void handle(ActionEvent event) {
                try {
                    dbHandler.signUpIncome(Float.parseFloat(SumField.getText()),ComField.getText()); // считываем данные логина и пароля после нажатия на кнопку запомнить
